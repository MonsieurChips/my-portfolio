...
export function BentoCard({
  ...
  return (
    ...
    >
      {title && <h3 className="text-lg font-semibold mb-2 text-zinc-900 dark:text-white">{title}</h3>}
      {description && <p className="text-zinc-600 dark:text-zinc-400 text-sm mb-4">{description}</p>}
      {children}
    </div>
  );
}
